...
### 2. Объектная модель, метапрограммирование, память

### 3. Основы HTTP. Сетевое взаимодействие
...
### 7. Разработка API. Django Rest Framework
...
### 11. Поисковые движки. Реализация или интеграция
